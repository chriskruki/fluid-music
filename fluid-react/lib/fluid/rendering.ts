...
import type { FluidConfig, Color } from '@/types/fluid'
import type { FBO, DoubleFBO, TextureObject } from '@/types/webgl'
import { Material, Program } from '@/lib/webgl/program-utils'
import { getTextureScale } from '@/lib/webgl/shader-utils'
...
export function render(
  ...
  if (config.SUNRAYS) {
    applySunrays(gl, config, dye.read, dye.write, sunrays, sunraysMaskProgram, sunraysProgram, blit)
